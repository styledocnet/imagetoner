...
const TimelineMinimap: React.FC<TimelineMinimapProps> = ({ tracks, visibleTimeRange, onRangeChange }) => {
  ...
  return (
    <div className="relative w-full h-full">
      <div ref={containerRef} className="relative h-full w-full bg-gray-900 rounded cursor-pointer" onMouseDown={handleMouseDown}>
        {/* Track previews */}
        ...
        {/* Viewport indicator */}
        <div
          className="absolute h-full bg-white bg-opacity-10 border border-blue-500 rounded"
          style={{
